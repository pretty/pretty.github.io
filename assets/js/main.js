...
*/
	...
	function createPhotoElement(photo) {
		...
		var caption = caption.substring(0,45) + '...';
...
(function($) {
	...
	$(function() {
		...
		var clientId = 'cb6e7d5a3a494948afd1542fa6a733ab';

		$('#two .carousel').on('didLoadInstagram', didLoadInstagram);
		$('#two .carousel').instagram({
			hash: 'stonefoxswim',
			count: 20,
			clientId: clientId
		});
